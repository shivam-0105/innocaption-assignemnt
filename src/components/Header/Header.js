              ...
              <ul className='flex top-links align-center'>
                <li className='flex align-center'>
                  ...
                  <ul className='social-links flex align-center'>
                    <li className='mx-2'>
                      <a href="https://www.facebook.com" target='_blank' className='fs-15'>
                        <i className='fab fa-facebook'></i>
                      </a>
                    </li>
                    <li className='mx-2'>
                      <a href="https://www.instagram.com" target='_blank' className='fs-15'>
                        <i className='fab fa-instagram'></i>
                      </a>
                    </li>
                    <li className='mx-2'>
                      <a href="https://twitter.com/home" className='fs-15'>
